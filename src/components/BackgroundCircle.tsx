...
const BackgroundCircle = () => {
  return (
    ...
    >
      <div className="absolute mt-52 h-[200px] w-[200px] animate-ping rounded-full border border-slate-200" />
      ...
      <div className="absolute mt-52 h-[650px] w-[650px] animate-pulse rounded-full border border-slate-500 opacity-20" />
